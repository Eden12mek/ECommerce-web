            ...
            <div data-aos="zoom-in"  className='grid md:grid-cols-3 pb-44 pt-5'>
                ...
                <div className='py-8 px-4'>
                   <h1 className='sm:text-3xl text-xl font-bold sm:text-left text-justify mb-3 flex items-center gap-3'>
                    ...
                    />
                    EdShop</h1> 
                   <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt velit ipsa ea, nemo ad ipsum molestiae temporibus aut esse quibusdam rerum unde. Delectus facilis molestias rem nesciunt sint, magni soluta.</p>
                </div>
